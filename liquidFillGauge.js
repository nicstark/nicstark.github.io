...
function liquidFillGaugeDefaultSettings(){
    return {
        ...
        waveHeight: .5, // The wave height as a percentage of the radius of the wave circle.
...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    var waveRiseScale = d3.scale.linear()
        ...
        // circle at 100%.
        .range([(fillCircleMargin+fillCircleRadius*4+waveHeight),(fillCircleMargin-waveHeight)])
        .domain([0,1]);
    ...
    // var rectangle = gaugeGroup.append("rect")
    //     .attr("width", radius*2)
